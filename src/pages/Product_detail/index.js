      ...
      <div className={cx('product-page')}>
        <div className={cx('image-gallery')}>
          ...
          <div className={cx('thumbnail-list')}>
            <img src={`${process.env.PUBLIC_URL}/assets/a2.jpg`} alt="Thumbnail 1" className={cx('thumbnail')} />
            <img src={`${process.env.PUBLIC_URL}/assets/a3.jpg`} alt="Thumbnail 2" className={cx('thumbnail')} />
            <img src={`${process.env.PUBLIC_URL}/assets/a4.jpg`} alt="Thumbnail 3" className={cx('thumbnail')} />
            <img src={`${process.env.PUBLIC_URL}/assets/a5.jpg`} alt="Thumbnail 4" className={cx('thumbnail')} />
            <img src={`${process.env.PUBLIC_URL}/assets/a6.jpg`} alt="Thumbnail 5" className={cx('thumbnail')} />
          </div>
        </div>
